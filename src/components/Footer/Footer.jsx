...
const Footer = () => {
  const { t } = useTranslation();
  const socialMedia = [
    { icon: "mdi:email-outline", url: "mailto:cristina.stoian@yahoo.com", label: "Email" },
    { icon: "fa6-brands:instagram", url: "https://www.instagram.com/crissalexx/", label: "Instagram" },
    { icon: "fa6-brands:linkedin", url: "https://www.linkedin.com/in/cristina-stoian-frontend-developer/", label: "LinkedIn" },
    { icon: "fa6-brands:github", url: "https://github.com/CristinaSt86", label: "GitHub" },
  ];
    ...
    <footer className={css.footer}>
      ...
      <div className={css.right}>
        {socialMedia.map((media) => (
          ...
          >
            <Icon icon={media.icon} className={css.socialIcon} />
          </a>
        ))}
      </div>
    </footer>
